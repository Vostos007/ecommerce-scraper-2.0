...
Все правки готовь как законченные патчи: держи код чистым, хорошо именованным и сопровождай нужными тестами. Если предлагаешь дальнейшие шаги, приложи соответствующие изменения в коде и опиши их в ответе.
